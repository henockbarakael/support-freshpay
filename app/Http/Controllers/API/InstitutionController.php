...
class InstitutionController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $sendData = Http::post('http://127.0.0.1:8086/services/create-institution', $data);
    ...
    public function user(){
        $response = Http::get('http://127.0.0.1:8086/services/paydrc/institution_user');
        $result = $response->json();
    ...
    public function storeUser(Request $request){
        ...
        $sendData = Http::post('http://127.0.0.1:8086/services/create-institution-user', $data);
        $response = json_decode($sendData->getBody(), true);
