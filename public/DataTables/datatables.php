...
class DataTableApi
{
    public $columnsDefault = [
        ...
        'status'=> true,
        'action'=> true,
        'thirdparty_reference'=> true,
        'paydrc_reference'=> true,
        'switch_reference'=> true,
        'telco_reference'=> true,
        'created_at'=> true,
        'updated_at'=> true,
    ];
    ...
    public function LastWeek(){
        $transactions = DrcSendMoneyTransac::whereBetween('created_at', [Carbon::now()->subWeek()->startOfWeek(), Carbon::now()->subWeek()->endOfWeek()])->where(['action' => "debit"])->orderBy('created_at','desc')->get();
        return $transactions;
    }
