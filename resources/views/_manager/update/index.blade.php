    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form action="{{route('manager.update.process')}}" method="POST">
                    @csrf
                    <!--begin::Card-->
                    <div class="card mb-7">
                        <!--begin::Card body-->
                                    ...
                                    <tr>
                                        ...
                                        @else
                                            <td class="text-center">
                                                {{-- <form method="POST" action="{{ route('manager.update.post')}}">
                                                    @csrf
    ...
    function successConfirmation(id) {
        Swal.fire({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{url('manager/success-single/')}}/" + id,
                    ...
                    success: function (results) {
                        if (results.success === true) {
                            ...
                            setTimeout(function(){
                                window.location.replace("{{url('manager/update-result')}}");
                            },3000);
                        } else {
    ...
    function failedConfirmation(id) {
        ...
        Swal.fire({
            ...
            if (e.value === true) {
                ...
                var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                var redirect = "{{route('manager.update.create')}}"
                $.ajax({
                    type: 'POST',
                    url: "{{url('manager/failed-single/')}}/" + id,
                    data: {_token: CSRF_TOKEN},
                    dataType: 'JSON',
                    success: function (results) {
                        if (results.success === true) {
