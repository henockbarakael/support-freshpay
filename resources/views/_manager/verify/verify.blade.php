                    ...
                    <tbody class="text-gray-600 fw-semibold" id="tbody">
                        ...
                        <tr id="tr_{{$row->switch_reference}}" class="text-start">
                            ...
                            {{-- <td class="text-center">
                                {!! Form::open(['method' => 'POST','route' => ['manager.success.single', Crypt::encrypt($row->switch_reference)],'style'=>'display:inline']) !!}
                                {!! Form::submit('S', ['class' => 'btn btn-success btn-border btn-sm rounded-2','data-toggle'=>'confirmation','data-placement'=>'left']) !!}
                                {!! Form::close() !!}

                                {!! Form::open(['method' => 'POST','route' => ['manager.failed.single', Crypt::encrypt($row->switch_reference)],'style'=>'display:inline']) !!}
