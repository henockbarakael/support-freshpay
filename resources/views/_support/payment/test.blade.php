...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../">
		<title>Payment | FreshPay Congo</title>
									...
									<div class="card-body p-lg-17">
										...
										<div class="row mb-3">
											...
											<div class="col-md-12 pe-lg-10">
												...
												<form action="{{route('support.payment.process')}}" method="POST" class="form mb-15">
                                                    @csrf
													<h1 class="fw-bolder text-dark" style="margin-bottom: 12px">Initiate Transaction</h1>
