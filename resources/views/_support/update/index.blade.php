    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <form action="{{route('support.update.process')}}" method="POST">
                    @csrf
                    <!--begin::Card-->
                    <div class="card mb-7">
                        <!--begin::Card body-->
                                ...
                                <div class="row g-8">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select name="option" class="form-select form-select-solid" data-hide-search="true">
                                            ...
                                            <option selected value="paydrc_reference">Paydrc Reference</option>
                                    ...
                                    <tr>
                                        ...
                                        @else
                                            <td class="text-center">
                                                {{-- <form method="POST" action="{{ route('support.update.post')}}">
                                                    @csrf
    ...
    function successConfirmation(id) {
        Swal.fire({
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{url('support/success-single/')}}/" + id,
                    ...
                    success: function (results) {
                        if (results.success === true) {
                            ...
                            setTimeout(function(){
                                window.location.replace("{{url('support/update-result')}}");
                            },3000);
                        } else {
    ...
    function failedConfirmation(id) {
        ...
        Swal.fire({
            ...
            if (e.value === true) {
                ...
                var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                var redirect = "{{route('support.update.create')}}"
                $.ajax({
                    type: 'POST',
                    url: "{{url('support/failed-single/')}}/" + id,
                    data: {_token: CSRF_TOKEN},
                    dataType: 'JSON',
                    success: function (results) {
                        if (results.success === true) {
