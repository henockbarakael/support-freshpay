    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card  myshadow2">
            <div class="card-body">
                ...
                <a href="#queue-upload" style="font-size: 12px"></a>File from merchant</h1>
                <div class="py-2">
                    <p>{{session('status')}}</p>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_example">
                    <thead>
                        <tr class="fw-bolder text-muted fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-80px">Thirdparty</th>
                    ...
                    <tbody class="text-gray-600 fw-semibold" id="tbody">
                        ...
                        <tr id="tr_{{$row->paydrc_reference}}" class="text-start">
                            ...
                            <td>{{$row['id']}}</td>
                            <td>{{$row['thirdparty_reference']}}</td>
...
var myDropzone = new Dropzone(id, { // Make the whole body a dropzone
    url: "import-merchant-file", // Set the url for your upload script location
    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
    parallelUploads: 20,
