    ...
    <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="d-flex align-items-center">
                        {{-- <div class="row g-8"> --}}
                            ...
                            <div class="col-sm-7">
                                ...
                                <!--begin::Select-->
                                <input type="text" class="form-control form-control form-control-solid" name="switch_reference" value="">
                                <!--end::Select-->
                            </div>
                            {{-- <div class="col-lg-3">
        ...
        <div class="card mt-6 myshadow2">
            ...
            <div class="card-body py-4">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable_zero_configuration">
                    <thead>
