    ...
    $(document).ready(function () {
        ...
        $('.verify-all').on('click', function(e) {
                ...
                // Start Multiple Paiement
                    ...
                    var redirect = "{{ url('admin/paydrc/transaction/verify') }}";
                    $.ajax({
                        url: "{{ url('admin/verify-select-ids') }}",
                        type: 'POST',
...
var myDropzone = new Dropzone(id, { // Make the whole body a dropzone
    url: "{{route('admin.transaction.verify.upload')}}", // Set the url for your upload script location
    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
    parallelUploads: 20,
