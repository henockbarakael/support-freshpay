...
@push('style')
<head><base href="">
    <title>Paydrc | Daily Payout</title>
...
@section('subtitle','Daily payout transaction')
{!! Toastr::message() !!}
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1" style="font-size: 12px">Transaction du {{$todayDate}}</span>
                            ...
                            <table class="table table-dark table-striped align-middle gs-0 gy-4" id="kt_datatable_example_1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["customer_details"]}}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["status"]}}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["thirdparty_reference"]}}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["paydrc_reference"]}}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["switch_reference"]}}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["telco_reference"]}}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["created_at"]}}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["updated_at"]}}</span>
                                        </td>
    ...
    var KTDatatablesExample = function () {
        ...
        var initDatatable = function () {
            ...
            datatable = $(table).DataTable({
                ...
                "columnDefs": [
                    { "name": "id",   "targets": 0 },
                    { "name": "merchant_code",  "targets": 1 },
                    { "name": "customer_details", "targets": 2 },
                    { "name": "amount",  "targets": 3 },
                    { "name": "currency", "targets": 4 },
                    { "name": "action", "targets": 5 },
                    { "name": "method", "targets": 6 },
                    { "name": "status", "targets": 7 },
                    { "name": "thirdparty_reference", "targets": 8 },
                    { "name": "paydrc_reference", "targets": 9 },
                    { "name": "switch_reference", "targets": 10 },
                    { "name": "telco_reference", "targets": 11 },
                    { "name": "created_at", "targets": 12 },
                    { "name": "updated_at", "targets": 13 }
                ],
                "language": {
        ...
        // Hook export buttons
        var exportButtons = () => {
            const documentTitle = 'Payout_'+'<?php echo $todayDate; ?>';
