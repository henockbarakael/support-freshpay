...
@section('page-title','Switch Database')
                                ...
                                <table class="table align-middle gs-0 gy-4" id="kt_datatable_example_1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["source_account_number"]}}</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["trans_type"]}}</span>
                                            </td>
                                            <td>
                                                <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["financial_institution"]}}</span>
                                            </td>
                                            <td>
                                                <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["status"]}}</span>
                                            </td>
                                            <td>
                                                <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["merchant_ref"]}}</span>
                                            </td>
                                            <td>
                                                <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["trans_ref_no"]}}</span>
                                            </td>
                                            <td>
                                                <span class="text-dark fw-semibold text-muted d-block fs-7">{{$value["financial_institution_transaction_id"]}}</span>
                                            </td>
                                            <td>
